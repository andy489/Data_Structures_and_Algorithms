...
- each integer <img src="https://latex.codecogs.com/svg.latex?\Large&space;arr[i]"> will be unique <img src="https://latex.codecogs.com/svg.latex?\Large&space;\underline{(our{\;}{\;}implementation{\;}{\;}works{\;}{\;}even{\;}{\;}without{\;}{\;}this{\;}{\;}condition)}">
