...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;mid=l+k*(r-l)">,

където

<img src="https://latex.codecogs.com/svg.latex?\Large&space;k=\frac{x-m[l].key}{m[r].key-m[l].key}">
