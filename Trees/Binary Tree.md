...
Maximum no. of nodes in a binary tree with height h is <img src="https://latex.codecogs.com/svg.latex?\Large&space;2^0+2^1+...+2^h=2^{h+1}-1=2^{no._of_levels}-1">. At deepest level we will have 2 to the power *h* nodes.
