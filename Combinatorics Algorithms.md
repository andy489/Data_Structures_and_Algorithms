...
**Задача 7.** Напишете функция, която пресмята по-колко начина може да се изберат <img src="https://latex.codecogs.com/svg.latex?\Large&space;k"> елемента от <img src="https://latex.codecogs.com/svg.latex?\Large&space;n"> елемента като използвате [триъгълника на Паскал](https://medium.com/i-math/top-10-secrets-of-pascals-triangle-6012ba9c5e23).
